# ddcti-2-json
#### project
- this script parses a selection of [deepdarkCTI](https://github.com/fastfire/deepdarkCTI) tables to convert them to a filtered `data.json` (only online entries kept)
